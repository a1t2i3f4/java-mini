...
<%
  ...
  try {
	  ...
	  String str = "select * from complains where dept='Electricity' and status='Pending'";
	 ...
	 while(rs.next()){
		 ...
		 <td scope="row"><a href="Electricity_dept_sol.jsp?id=<%=rs.getString("id")%>">Resolve</a></td>
