      ...
      <ul class="nav-links">
        ...
        <li>
          <a href="citizen_login.jsp">
            <i class='bx bx-box' ></i>
            <span class="links_name">Water Department</span>
          </a>
        </li>
                <br><br>
        ...
        <li>
          <a href="citizen_login.jsp">
            ...
            <span class="links_name">Road and Transport Department</span>
          </a>
        </li>
        <li>
        <br><br> 	
          <a href="citizen_login.jsp">
            ...
            <span class="links_name">Electricity Department</span>
          </a>
        </li>
        ...
        <li>
          <a href="citizen_login.jsp">
            ...
            <span class="links_name">Fire and Emergency</span>
          </a>
        </li>
        <li>
        <br><br>
          <a href="citizen_login.jsp">
            ...
            <span class="links_name">Solid Waste Management</span>
          </a>
        </li>
      ...
      <div class="overview-boxes">
        <div class="box">
          <div class="right-side">
            <div class="box-topic">Total Population in the City</div>
        ...
        <div class="box">
          <div class="right-side">
            <div class="box-topic">Repeated Users</div>
        ...
        <div class="box">
          <div class="right-side">
            <div class="box-topic"> Smart city Program</div>
                        <div class="indicator">
                <i class='bx bx-up-arrow-alt'></i>
