...
<title>Solid Waste Department</title>
</head>
...
<%
  ...
  try {
	  ...
	  String str = "select * from complains where dept='Solid' and status='Pending'";
	 ...
	 while(rs.next()){
		 ...
		 <td scope="row"><a href="SolidWaste_dept_sol.jsp?id=<%=rs.getString("id")%>">Resolve</a></td>
